...
\input{./lectures/l2-p2p}
\newpage
\input{./lectures/l3-osn}
\newpage
\input{./lectures/l4-osn_struct-prop}
\newpage
\input{./lectures/l5-network_models}
\newpage
\input{./lectures/l6-info_cascade}
\newpage
\input{./lectures/l7-sn_applications}
